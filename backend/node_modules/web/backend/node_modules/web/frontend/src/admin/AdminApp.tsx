...
import DashboardPage from './pages/DashboardPage' // <-- Sửa lỗi: Thêm lại .tsx
import OrdersPage from './pages/OrdersPage' // <-- Sửa lỗi: Thêm lại .tsx
import ProductsPage from './pages/ProductsPage' // <-- Sửa lỗi: Thêm lại .tsx
import UsersPage from './pages/UsersPage' // <-- Sửa lỗi: Thêm lại .tsx
import AdminProtectedRoute from './components/AdminProtectedRoute' // <-- Sửa lỗi: Thêm lại .tsx
import BlogsPage from './pages/BlogPage' // <-- Sửa lỗi: Thêm lại .tsx
import VouchersPage from './pages/VouchersPage' // <-- Sửa lỗi: Thêm lại .tsx
import ReportPage from './pages/ReportPage' // <-- Sửa lỗi: Thêm lại .tsx
import { 
  LayoutDashboard, 
  ShoppingCart, 
  Package, 
