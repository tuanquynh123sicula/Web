 ...
 * ```
 */
export declare function modelOptions<U extends AnyParamConstructor<any> = any, QueryHelpers = BeAnObject>(options: IModelOptions<U, QueryHelpers>): ClassDecorator;
