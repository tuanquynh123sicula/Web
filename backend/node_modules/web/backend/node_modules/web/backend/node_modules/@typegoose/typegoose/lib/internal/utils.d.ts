 ...
 */
export declare function mergeSchemaOptions<U extends AnyParamConstructor<any>>(value: mongoose.SchemaOptions | undefined, cl: U): mongoose.SchemaOptions<any, IObjectWithTypegooseFunction, import("../types").BeAnObject, import("../types").BeAnyObject, import("../types").BeAnyObject, any, mongoose.Model<any, import("../types").BeAnObject, IObjectWithTypegooseFunction, import("../types").BeAnyObject, any, any>> | undefined;
/**
