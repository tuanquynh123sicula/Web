...
export default function AddToWishlistBtn({ productId }) {
    ...
    return (_jsx("button", { onClick: handleToggleWishlist, disabled: isChecking, className: `p-2 rounded-full transition ${inWishlist
            ? 'bg-red-100 text-red-600 hover:bg-red-200'
            : 'bg-gray-100 text-gray-600 hover:bg-gray-200'} disabled:opacity-50`, title: inWishlist ? 'Xóa khỏi yêu thích' : 'Thêm vào yêu thích', children: _jsx(Heart, { size: 20, fill: inWishlist ? 'currentColor' : 'none' }) }));
}
