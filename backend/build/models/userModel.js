...
let User = (() => {
    ...
    var User = _classThis = class {
        constructor() {
            ...
            this.tier = (__runInitializers(this, _isAdmin_extraInitializers), __runInitializers(this, _tier_initializers, void 0));
    ...
    (() => {
        ...
        _email_decorators = [(0, typegoose_1.prop)({ required: true, unique: true })];
        _password_decorators = [(0, typegoose_1.prop)({ required: true })];
        _isAdmin_decorators = [(0, typegoose_1.prop)({ required: true, default: false })];
        _tier_decorators = [(0, typegoose_1.prop)({ enum: ['regular', 'vip', 'new'], default: 'regular' })];
